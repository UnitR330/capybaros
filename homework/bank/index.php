...
<head>
    ...
    <link rel="stylesheet" href="http://localhost:8080/_46-grupe_/capybaros/homework/bank/css/style.css">
</head>
<body>
    <header class="floating-header">
        ...
        <div class="header-right">
           ...
           <?php else: ?>
           <a href="http://localhost:8080/_46-grupe_/capybaros/homework/bank/sign_in.php">
