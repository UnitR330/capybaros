...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/_46-grupe_/capybaros/homework/bank/css/style.css">
</head>
<body>
    <header class="floating-header">
        ...
        <div class="header-right">
           ...
           <a href="http://localhost/_46-grupe_/capybaros/homework/bank/authorized.php">
           <button class="authorized">Personal account</button>
           </a>
           <?php else: ?>
           <a href="http://localhost/_46-grupe_/capybaros/homework/bank/sign_in.php">
